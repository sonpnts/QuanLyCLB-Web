    ...
    try {
      ...
      return {
        ...
        data: {
          ...
          registrationFeeTotal: Number(payload.registrationFeeTotal || 0),
          facilityFeeTotal: Number(payload.facilityFeeTotal || 0),
          codeChangeFeeTotal: Number(payload.codeChangeFeeTotal || 0),
          otherFeesTotal: Number(payload.otherFeesTotal || 0),
